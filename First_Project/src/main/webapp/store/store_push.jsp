...
<body>
	...
	<!-- 상품정보 -->
		<!-- 상품명 -->
		<div class="store_subject"><strong >스위트 콤보</strong></div> 
		
		<!-- 상품 상세정보 box_store_view-->
		<!-- 상품상세 이미지 box_store_view.left.img -->
		<div class="box_store_view">
			<div class="left">
				<div class="img">
	...
	- 관람권 구매금액보다 낮은 금액의 티켓 구매 시 구매금액이 아닌 티켓 금액으로 VIP 승급금액이 반영됩니다. (예; 조조, 심야, 문화의 날 등)<br></div>
</body>
	<footer>
