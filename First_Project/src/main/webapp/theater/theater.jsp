 	...
 	<div class="theater_">
		<div id="wrapper">
			...
			<div style="text-align: center;">
				<img src="./image/CGV서면.png" alt="cgv" id="image">
			</div>
		<section id="content">
			<hr class="theater_hr">
				<div class = "menu">
