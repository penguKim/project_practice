 	...
 	<div id="wrapper">
		...
		<div id="content">
			...
			<ul class="tab-menu" id="menu">
				<li><a href="theater.jsp#sec07" >관람료안내</a></li>
...
<div class="col-detail"> 
    <div class="sect-theater-info">
        <h4><span class="ico-bus"><img src="../img/교통안내.png"></span>&nbsp;교통안내</h4>
    ...
    <div class="sect-theater-info">
		<h4><span class="ico-bus"><img src="../img/주차안내.png"></span>주차안내</h4>
        <div class="info-contents">
           ...
           1. 홈플러스 지하주차장<br>
			...
			<ul>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img alt="" height="206" src="../img/주차장약도.jpg" width="606"></li>
				<li>&nbsp;</li>
			</ul>
            <p></p>
            <br><br>
